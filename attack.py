...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="仅执行疑似数据窃取攻击阶段")
    ...
    parser.add_argument("--attack-log-path", type=str, default="logs/attack_metrics.log", help="攻击日志输出路径")
    ...
    parser.add_argument("--mask-ratio", type=float, default=None, help="覆盖默认 mask 比例")
